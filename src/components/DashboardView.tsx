...
export const DashboardView: React.FC = () => {
  ...
  return (
    <div className="space-y-5 pb-12 animate-fadeIn max-w-6xl mx-auto font-sans">
      ...
      <div className="bg-[#0c1220] rounded-2xl p-4 sm:p-5 border border-[#1e293b] shadow-xl flex flex-wrap items-center justify-between gap-4">
        {/* Franchise Identity */}
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] uppercase font-black tracking-widest text-[#D4AF37] px-2 py-0.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/20">
        ...
        <div className="flex items-center gap-3 sm:gap-6 ml-auto flex-wrap">
          ...
          <div className="text-center sm:text-right">
            <p className="text-[9px] uppercase font-bold tracking-widest text-[#64748b]">Standing</p>
          ...
          {/* Form Streak */}
          <div className="text-center sm:text-right">
            <p className="text-[9px] uppercase font-bold tracking-widest text-[#64748b]">Record & Form</p>
            <p className="text-xs sm:text-sm font-black text-white leading-tight flex items-center gap-1 justify-end">
              <span className="text-emerald-400 font-mono">{userStanding?.won || 0}W</span>
              <span className="text-[#64748b]">-</span>
              <span className="text-red-400 font-mono">{userStanding?.lost || 0}L</span>
          ...
          {/* Purse */}
          <div className="text-center sm:text-right">
            <p className="text-[9px] uppercase font-bold tracking-widest text-[#64748b]">Purse Available</p>
            <p className="text-base sm:text-lg font-black font-mono text-[#D4AF37] leading-tight">
      ...
      {nextFixture && fixtureTeamA && fixtureTeamB ? (
        <div className="relative bg-gradient-to-b from-[#0e1628] via-[#090e1a] to-[#060a12] rounded-3xl border border-[#1e293b] overflow-hidden shadow-2xl p-6 sm:p-8">
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-5">
            ...
            <div className="flex items-center gap-2">
              <div className="px-3 py-1 rounded-full bg-[#1e293b]/80 border border-white/10 text-[10px] font-black uppercase tracking-widest text-amber-300 flex items-center gap-1.5 shadow-sm">
                <Calendar className="w-3 h-3 text-[#D4AF37]" />
                <span>MATCHDAY {nextFixture.matchNumber}</span>
              </div>
              <div className="px-3 py-1 rounded-full bg-[#0f172a]/80 border border-white/10 text-[10px] font-bold uppercase tracking-wider text-[#94a3b8] flex items-center gap-1.5">
            ...
            <div className="flex items-center justify-center space-x-6 sm:space-x-12 my-2 w-full max-w-xl">
              ...
              >
                <div 
                  className={`w-20 h-20 sm:w-24 sm:h-24 rounded-2xl flex items-center justify-center font-black text-2xl sm:text-3xl shadow-2xl border-2 transition-transform group-hover:scale-105 ${
                    fixtureTeamA.id === gameState.userTeamId ? 'border-[#D4AF37] ring-4 ring-[#D4AF37]/20' : 'border-white/20'
                  }`}
                  style={{ 
                ...
                <h3 className="text-xs sm:text-sm font-black uppercase tracking-wider text-white mt-2.5 group-hover:text-[#D4AF37] transition">
                  {fixtureTeamA.name}
                </h3>
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full bg-[#1e293b] border border-white/10 flex items-center justify-center font-black text-xs italic text-[#94a3b8] shadow-inner">
                  VS
                </div>
                <span className="text-[9px] uppercase font-bold text-[#64748b] mt-1 tracking-widest">T20</span>
              </div>
              ...
              >
                <div 
                  className={`w-20 h-20 sm:w-24 sm:h-24 rounded-2xl flex items-center justify-center font-black text-2xl sm:text-3xl shadow-2xl border-2 transition-transform group-hover:scale-105 ${
                    fixtureTeamB.id === gameState.userTeamId ? 'border-[#D4AF37] ring-4 ring-[#D4AF37]/20' : 'border-white/20'
                  }`}
                  style={{ 
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#94a3b8] mt-0.5">
            ...
            <p className="text-xs text-[#94a3b8] max-w-md italic">
              {fixtureOpponentTeam 
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-md pt-2">
              {isUserInNextMatch && (
                <button
                  ...
                  onClick={() => setActiveTab('PlayingXI')}
                  className="w-full sm:flex-1 py-3 px-5 rounded-2xl bg-[#1e293b] hover:bg-[#2b3a4f] text-white font-black text-xs uppercase tracking-wider border border-white/10 transition cursor-pointer flex items-center justify-center gap-2"
                >
              ...
              <button
                ...
                className="w-full sm:flex-1 py-3.5 px-6 rounded-2xl bg-gradient-to-r from-[#D4AF37] via-amber-400 to-amber-300 text-black font-black text-xs sm:text-sm uppercase tracking-widest hover:scale-105 active:scale-95 transition-transform flex items-center justify-center gap-2 shadow-xl shadow-[#D4AF37]/20 cursor-pointer"
              >
        ...
        <div className="bg-[#0e1628] rounded-3xl border border-[#1e293b] p-8 text-center shadow-2xl">
          ...
          <p className="text-xs text-[#94a3b8] mt-1">Review the final standings or initiate the next season campaign.</p>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[#0c1220] rounded-2xl p-4 sm:p-5 border border-[#1e293b] shadow-lg flex flex-col justify-between space-y-4 hover:border-[#D4AF37]/30 transition group">
          <div>
            <div className="flex items-center justify-between">
              <span className="text-[10px] uppercase font-black tracking-widest text-[#64748b] flex items-center gap-1.5">
          ...
          <div>
            <div className="w-full bg-[#05070a] rounded-full h-2 overflow-hidden mb-3 border border-[#1e293b]">
              <div 
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-[#1e293b] group-hover:bg-blue-600 group-hover:text-white text-xs font-black uppercase tracking-wider text-blue-300 transition cursor-pointer flex items-center justify-center gap-1.5"
            >
        ...
        <div className="bg-[#0c1220] rounded-2xl p-4 sm:p-5 border border-[#1e293b] shadow-lg flex flex-col justify-between space-y-4 hover:border-amber-500/30 transition group">
          <div>
            <div className="flex items-center justify-between">
              <span className="text-[10px] uppercase font-black tracking-widest text-[#64748b] flex items-center gap-1.5">
              ...
              {unclaimedRewards > 0 ? (
                ...
                <span className="text-[10px] font-bold text-[#64748b]">CLAIMED</span>
              )}
            </div>
          ...
          <div>
            <button
              ...
              className={`w-full py-2.5 rounded-xl text-xs font-black uppercase tracking-wider transition cursor-pointer flex items-center justify-center gap-1.5 ${
                unclaimedRewards > 0 
                  ? 'bg-gradient-to-r from-amber-500 to-[#D4AF37] text-black shadow-lg shadow-amber-500/20 hover:scale-102' 
                  : 'bg-[#1e293b] group-hover:bg-[#334155] text-amber-300'
              }`}
            >
        ...
        <div className="bg-[#0c1220] rounded-2xl p-4 sm:p-5 border border-[#1e293b] shadow-lg flex flex-col justify-between space-y-4 hover:border-purple-500/30 transition group">
          <div>
            <div className="flex items-center justify-between">
              <span className="text-[10px] uppercase font-black tracking-widest text-[#64748b] flex items-center gap-1.5">
          ...
          <div>
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-[#1e293b] group-hover:bg-purple-600 group-hover:text-white text-xs font-black uppercase tracking-wider text-purple-300 transition cursor-pointer flex items-center justify-center gap-1.5"
            >
        ...
        <div className="bg-[#0c1220] rounded-2xl p-4 sm:p-5 border border-[#1e293b] shadow-lg flex flex-col justify-between space-y-4 hover:border-emerald-500/30 transition group">
          <div>
            <div className="flex items-center justify-between">
              <span className="text-[10px] uppercase font-black tracking-widest text-[#64748b] flex items-center gap-1.5">
          ...
          <div>
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-[#1e293b] group-hover:bg-emerald-600 group-hover:text-white text-xs font-black uppercase tracking-wider text-emerald-300 transition cursor-pointer flex items-center justify-center gap-1.5"
            >
